...
with st.container():
    ...
    # get obj:
    # objs = []
    # objs_file = open('./n_dict-less-3.0.csv', 'r', encoding='GBK')
    # for line in objs_file.readlines():
    #     print(line.split(",")[0])
    #     objs.append(line.split(",")[0])
    objs = ["空间","客厅","卧室","墙面","餐厅","公寓","住宅","沙发","家具","地毯","厨房","书房","背景墙","吊灯","墙",
           "卫生间","儿童","床品","装饰","壁纸","地板","窗帘","吊顶","餐椅","别墅","地面","结构","布艺","餐桌","画"]
    obj = CLIP.usage.calculate.get_clip_score('902/epoch_50.pt', img1_id, objs)
