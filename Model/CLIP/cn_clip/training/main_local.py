...
def main():
    ...
    args.logs = "../../../data/experiments"
    args.name = "muge_finetune_vit-b-16_roberta-base_bs128_8gpu"
    ...
    args.text_model = "RoBERTa-wwm-ext-base-chinese"
    ...
    # Initialize dataset and dataset
    ...
    if args.resume is not None:
        if os.path.isfile(args.resume):
            ...
            # Restore the epoch and steps info, reload the dataset and dataset for the resume epoch
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        # if exists next epoch, reload the dataset and dataset for the next epoch
